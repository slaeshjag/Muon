...
void menu_settings_init() {
	...
	settings_game_button_ok=ui_widget_create_button_text(font_std, "OK");
	...
	ui_hbox_add_child(settings_monitor_hbox_fullscreen, ui_widget_create_label(font_std, "Fullscreen"), 0);
	...
	ui_hbox_add_child(settings_monitor_hbox_alpha, ui_widget_create_label(font_std, "Alpha blending"), 0);
	...
	settings_monitor_button_ok=ui_widget_create_button_text(font_std, "OK");
	...
	settings_monitor_button_cancel=ui_widget_create_button_text(font_std, "Cancel");
